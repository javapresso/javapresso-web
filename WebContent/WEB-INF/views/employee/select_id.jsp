	...
	<form id="updateForm" method="post"
		...
		<div class="button-group" style="margin-top: 20px;">
			<button id="btnCancel" class="btn-earn-pass">
				<fmt:message key="empSel.ButtonBack" />
			</button>
