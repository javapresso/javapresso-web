...
<util:layout menuList="${sideMenus}">
      ...
      <input type="text" class="phonenumber" placeholder="전화번호를 입력하세요" maxlength="11" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"/>
       
      </div>

      <div class="button-group">
        <button class="btn-earn-points">확인하기</button>
      </div>
    </div>
</util:layout>
