...
public class MenuDao {
  ...
  public List<String> getMenuHeader() {
    ...
    try (Connection con = dataSource.getConnection()) {
      ...
      String sql = "SELECT " + "category_name, menu_name, price, is_soldout, iceable, description "
  ...
  public ArrayList<String> getChildCategories(String parent) {
    ...
    try (Connection con = dataSource.getConnection()) {
      ...
      String sql = "SELECT category_name FROM" + "(SELECT category_name, parent_name, LEVEL "
          + "FROM categories " + "START WITH parent_name IS NULL "
          + "CONNECT BY PRIOR category_name = parent_name) " + "WHERE parent_name = ?";
      ...
      while (rs.next())
        subCategories.add(rs.getString("category_name"));
